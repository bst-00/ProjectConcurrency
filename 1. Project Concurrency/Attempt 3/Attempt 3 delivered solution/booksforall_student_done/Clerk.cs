...
// this is the work that the clerk does
                            ...
                            // do not alter the order of the instructions.
    {
        ...
        // Acquire lock to put book on counter
        Program.counter_sem_empty.WaitOne();
        ...
        Program.counter_sem_full.Release();
        
        Thread.Sleep(new Random().Next(100, 500));
        //the clerk will take a nap for overworking


        //////////////////////////////CLERK: PICKING UP BOOK AT DROPOFF COUNTER///////////////////////////////////////////
        // Acquire lock to take book from dropoff
        Program.dropoff_sem_full.WaitOne();
        Program.mutex.WaitOne();
        ...
        Program.mutex.ReleaseMutex();
        Program.dropoff_sem_empty.Release();
