...
namespace Quiz
{
    ...
    class SubmissionParams
    {
        ...
        public const string classNumber = "wf"; // This must be filled. INF2A is just an example.
    }
    ...
    class FixedParams
    {
        ...
        public const int minThinkingTimeTeacher = 50 / multiplier;
        public const int maxThinkingTimeTeacher = 200 / multiplier;
        public const int minThinkingTimeStudent = 20 / multiplier;
        public const int maxThinkingTimeStudent = 100 / multiplier;
        public const int maxNumOfQuestions = 40 / multiplier; 
        public const int maxNumOfStudents = 200 / multiplier;
        public const int maxNumOfTeachers = 10 / multiplier;
