...
class Program
{
    ...
    private static readonly string studentname1 = "Bruno van der Stel";
    private static readonly string studentnum1 = "1005978";
    ...
    public static object sharedOrdersLock = new object();
    public static object sharedPickupsLock = new object();
    ...
    private static readonly int total_coocks = 500; // this needs to be the same as the number of clients
    ...
    {   // feel free to change the code in this method if needed
        ...
        {
            Thread CookThread = new(() => cook.DoWork());
            CookThread.Start();
        }
    }
    ...
    {   // feel free to change the code in this method if needed
        ...
        {
            Thread clientThread = new(() => client.DoWork());
            clientThread.Start();
        }
    }
